...
export const COMPANY = {
  ...
  whatsappLink:
    "https://wa.me/917398306179?text=" +
    encodeURIComponent("Hi, I'd like to enquire about a tour/bus hire."),
...
export type Pkg = {
  ...
  highlights: string[];
  tag: string;
  category: "pilgrimage" | "nepal" | "circuit" | "custom";
  alt: string;
};
...
export const PACKAGES: Pkg[] = [
  {
    id: "varanasi-budget",
    name: "Varanasi — Budget Package",
    duration: "2–5 Days",
    price: "From ₹1,800/person",
    highlights: ["Ganga Aarti", "Kashi Vishwanath", "Sarnath", "Ghat Walk"],
    tag: "Budget-Friendly",
    category: "pilgrimage",
  ...
  {
    id: "varanasi-mid",
    name: "Varanasi — Mid-Range Package",
    duration: "2–5 Days",
    price: "From ₹5,000/person",
    highlights: ["Heritage Hotel", "Private Boat", "Licensed Guide", "Sarnath"],
    tag: "Most Popular",
    category: "pilgrimage",
  ...
  {
    id: "varanasi-luxury",
    name: "Varanasi — Luxury Package",
    duration: "2–5 Days",
    price: "From ₹25,000/person",
    highlights: [
      "Palace Hotel",
      "Private Scholar Guide",
      "Silk Atelier",
  ...
  },
  {
    ...
    highlights: ["Ram Mandir Darshan", "Saryu Boat Ride", "Kanak Bhavan", "Hanuman Garhi"],
    tag: "Spiritual",
    category: "pilgrimage",
  ...
  },
  {
    ...
    highlights: ["Sangam Holy Dip", "Anand Bhavan", "Chitrakoot Day Trip", "Ganga Aarti"],
    tag: "Spiritual",
    category: "pilgrimage",
  ...
  },
  {
    ...
    highlights: ["Mahabodhi Temple", "Vishnupad Temple", "Rajgir–Nalanda", "Dungeshwari Caves"],
    tag: "Hindu & Buddhist",
    category: "pilgrimage",
  ...
  },
  {
    ...
    duration: "2–4 Days",
    price: "From ₹5,000/person",
    highlights: ["Chakra Teertha", "Lalita Devi Shakti Peetha", "Lucknow Day Trip", "Forest Walk"],
    tag: "Hidden Gem",
    category: "pilgrimage",
  ...
  },
  {
    ...
    duration: "3–4 Days",
    price: "From ₹7,000/person",
    highlights: ["Ram-Janaki Temple", "Mithila Art", "Vivah Panchami", "Sitamarhi Crossing"],
    tag: "Nepal",
    category: "nepal",
  ...
  {
    id: "kathmandu",
    name: "Kathmandu Darshan",
    duration: "3–4 Days",
    price: "From ₹22,000/person",
    highlights: ["Pashupatinath", "Boudhanath", "3 Durbar Squares", "Swayambhunath"],
    tag: "Nepal",
    category: "nepal",
  ...
  {
    id: "pokhara",
    name: "Pokhara & Poon Hill",
    duration: "3–4 Days",
    price: "From ₹18,000/person",
    highlights: ["Phewa Lake", "Paragliding", "World Peace Pagoda", "Poon Hill Sunrise Trek"],
    tag: "Nepal • Adventure",
    category: "nepal",
  ...
  {
    id: "up-circuit",
    name: "Kashi–Prayag–Ayodhya–Naimisharanya Circuit",
    duration: "5–7 Days",
    price: "Group Package",
    highlights: ["Complete UP Pilgrimage Circuit", "~820 km", "20–45 passengers"],
    tag: "Group Circuit",
    category: "circuit",
  ...
  {
    id: "nepal-circuit",
    name: "Nepal Full Pilgrimage Circuit",
    duration: "10–14 Days",
    price: "Group Package",
    highlights: ["Lumbini, Janakpur, Kathmandu", "Pokhara, Muktinath", "Pashupatinath"],
    tag: "Nepal • Group Circuit",
    category: "circuit",
  ...
  },
  {
    ...
    duration: "7–9 Days",
    price: "Group Package",
    highlights: ["Sarnath, Kushinagar, Lumbini", "Bodh Gaya, Rajgir, Nalanda", "~1050 km"],
    tag: "Buddhist",
    category: "circuit",

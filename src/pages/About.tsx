    ...
    <>
      ...
      <section className="border-y bg-secondary/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          {[
            ...
            <div key={v}>
              <div className="text-3xl font-bold text-navy">{k}</div>
              <div className="text-xs uppercase tracking-wide text-muted-foreground mt-1">{v}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <p className="text-muted-foreground mt-2 max-w-2xl">
          Owned, maintained, and GPS-tracked — every bus is ready for pilgrimages, school tours,
          weddings, and corporate trips. See full hire details on the{" "}
        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {[
            {
              src: busExterior,
              caption: "Neelkamal — All India Tourist Permit Coach",
              alt: "Aarya Neelkamal tourist coach exterior with All India Tourist Permit",
            },
            {
              src: busInterior1,
              caption: "Premium AARYA branded interior with mood lighting",
              alt: "Aarya bus interior with branded headrests and ambient lighting",
            },
            {
              src: busInterior2,
              caption: "Spacious cabin for long pilgrimage circuits",
              alt: "Spacious bus interior for long-distance pilgrimage tours",
            },
            {
              src: busExterior,
              caption: "Tourist-permitted for pan-India & Nepal",
              alt: "Tourist permit bus for Varanasi to Nepal pilgrimage tours",
            },
            {
              src: busInterior1,
              caption: "Comfort seating for group travel",
              alt: "Comfortable group travel bus interior",
            },
            {
              src: busInterior2,
              caption: "Well-lit, ventilated coach",
              alt: "Well-lit and ventilated coach interior",
            },
          ].map((b, i) => (
            ...
            {[
              {
                icon: Award,
                t: "Experienced Team",
                d: "30+ years guiding pilgrimages and group travel.",
              },

...
export default function PlanTrip() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.success("Your trip plan is on its way!", {
        description: "We'll craft an itinerary and respond within 2–4 hours.",
      });
      setForm(initial);
      setStep(0);
      navigate("/");
  ...
  const field =
    "mt-1 w-full rounded-lg border bg-card px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-saffron transition";
  ...
  return (
    <>
      <Hero
        ...
        title={
          <>
            Let us plan your <span className="text-saffron">perfect journey</span>
          </>
        }
      ...
      <section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <div className="h-1.5 w-full overflow-hidden rounded-full bg-secondary">
            <div
              className="h-full rounded-full bg-gradient-to-r from-saffron to-amber-500 transition-all duration-500"
          ...
          <ol className="mt-4 hidden sm:flex justify-between">
            {stepTitles.map((t, i) => (
              <li key={t} className="flex flex-col items-center gap-1.5 flex-1">
                <span
                  className={`step-dot grid place-items-center h-7 w-7 rounded-full text-xs font-bold ${i <= step ? "bg-saffron text-saffron-foreground" : "bg-secondary text-muted-foreground"}`}
                >
                  {i < step ? <CheckCircle2 className="h-4 w-4" /> : i + 1}
                </span>
                <span
                  className={`text-[11px] ${i === step ? "text-navy font-semibold" : "text-muted-foreground"}`}
                >
                  {t}
                </span>
              </li>
          ...
          {step === 0 && (
            <div className="space-y-5">
              <div className="flex items-center gap-3">
                <div className="grid place-items-center h-11 w-11 rounded-lg bg-saffron/15 text-saffron">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Kashi + Ayodhya, Kathmandu, Pokhara"
                  required
                  maxLength={200}
                />
              </div>
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Approximate is fine — we can refine later.
                  </p>
                </div>
              </div>
              <div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Choose a style and budget to help us design.
                  </p>
                </div>
              </div>
              <div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Special meals, accessibility needs, must-see temples, language preference…"
                />
              </div>
            </div>
          )}
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    We'll respond within 2–4 hours with a custom plan.
                  </p>
                </div>
              </div>
              <div>
              ...
              <div className="rounded-lg bg-secondary/60 p-4 text-xs text-muted-foreground">
                ...
                <p>
                  {form.destination || "—"} · {form.travellers} traveller(s) ·{" "}
                  {form.tripType || "—"} · {form.budget || "—"}
                </p>
              </div>
            </div>
          )}
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          Prefer to chat?{" "}
          <a className="text-saffron font-semibold hover:underline" href="/contact">
            Contact us directly
          </a>{" "}

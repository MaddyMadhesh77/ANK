...
export function PackageDetailDialog({ pkg, trigger }: Props) {
  ...
  const wa = buildWhatsAppLink(
    `Hi, I am interested in the ${pkg.name} package. Please share details.`,
  );
  return (
        ...
        {img && (
          <div className="relative aspect-[16/9] bg-secondary shrink-0">
            ...
            <div className="absolute bottom-3 left-4 right-4 text-white">
              <span className="inline-block text-[11px] font-semibold tracking-wide bg-saffron text-saffron-foreground rounded-full px-2.5 py-0.5">
                {pkg.tag}
              </span>
            </div>
          </div>
